<?php
 ...
 function readallvalidatedmessagesbyuser(){
	...
	$stmt2 = $mysqli->prepare("SELECT message, valid FROM vpamsg3eh WHERE validator=?");
	echo $mysqli->error;
  ...
  function allvalidmessages(){
	...
	$valid = 1;
	$mysqli = new mysqli($GLOBALS["serverHost"], $GLOBALS["serverUsername"], $GLOBALS["serverPassword"], $GLOBALS["database"]);
	$stmt = $mysqli->prepare("SELECT message FROM vpamsg3eh WHERE valid=? ORDER BY validated DESC");
	echo $mysqli->error;
...
function validatemsg($editId, $validation){
	$mysqli = new mysqli($GLOBALS["serverHost"], $GLOBALS["serverUsername"], $GLOBALS["serverPassword"], $GLOBALS["database"]);
	$stmt = $mysqli->prepare("UPDATE vpamsg3eh SET validator=?, valid=?, validated=now() WHERE id=?");
  ...
  function readmsgforvalidation($editId){
	$notice = "";
	$mysqli = new mysqli($GLOBALS["serverHost"], $GLOBALS["serverUsername"], $GLOBALS["serverPassword"], $GLOBALS["database"]);
	$stmt = $mysqli->prepare("SELECT message FROM vpamsg3eh WHERE id = ?");
